...
class GatedMaskedConv2(nn.Module):
    def __init__(self, mask_type, dim, kernel, residual=True, n_classes=10, bh_model=True):
        super().__init__()
...
class GatedPixelCNN(nn.Module):
    def __init__(self, input_dim=256, dim=64, n_layers=15, n_classes=10, audio=False, bh_model=False):
        ...
        for i in range(n_layers):
            ...
            self.layers.append(
                GatedMaskedConv2(mask_type, dim, kernel, residual, n_classes, bh_model)
            )
